...
describe('shadow monitor decision history helpers', () => {
  it('labels switch reasons and legacy event groups', () => {
    ...
    expect(formatShadowEventType({ type: 'switch_api_completed' })).toBe('Switch API Completed')
    ...
    expect(getShadowEventDecisionGroup({ type: 'switch_api_completed' })).toBe('switch')
