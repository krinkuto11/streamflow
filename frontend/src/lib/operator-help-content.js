  ...
  },
  {
    ...
    settings: [
      ...
      },
      {
        ...
        location: 'Stream Checker -> Current Progress -> Stream Progress Tracking -> Status',
        locationTo: '/stream-checker',
      ...
      },
      {
        ...
        location: 'Changelog -> Action filter: Automation Runs -> Automation Period (expand) -> Channel -> Quality Check -> Analyzed Streams -> Reason',
    ...
    smokeChecks: [
      ...
      'A missing current bitrate either recovers during Bitrate Recheck, ends with Bitrate unavailable after recheck, or remains Capacity deferred when no provider/profile slot was available.',
