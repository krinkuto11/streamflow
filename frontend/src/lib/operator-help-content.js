...
export const operatorHelpDetailTopics = [
  ...
  },
  {
    ...
    steps: [
      'Shadow Monitor now uses Continuous mode as its only normal viewer-following behavior.',
    ...
    settings: [
      ...
      },
      {
        ...
        effect: 'Follows active viewer sessions and runs guarded media probes while the viewer is still connected. Legacy periodic config is normalized to continuous.',
