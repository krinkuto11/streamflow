...
export const operatorHelpDetailTopics = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Use Pre-Start Retries as comma-separated minute offsets before start, such as 10 and 3 minutes, for late renames before kickoff.',
      'Use Post-Start Checks as comma-separated minute offsets after start, such as 2 and 4 minutes, for channels that only appear at kickoff or shortly after.',
    ...
    settings: [
      ...
      },
      {
        ...
        effect: 'Comma-separated minute offsets before start. Each value schedules one extra pre-start check bucket without changing the main preflight offset.',
      ...
      },
      {
        ...
        effect: 'Comma-separated minute offsets after start. Each value schedules one post-start check bucket inside Post Start Grace.',
