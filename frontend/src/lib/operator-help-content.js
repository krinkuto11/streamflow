  ...
  },
  {
    ...
    settings: [
      ...
      },
      {
        ...
        location: 'Stream Checker -> active stream details -> Needs Recheck; Changelog -> Quality Check -> stream detail',
        locationTo: '/stream-checker',
        effect: 'Keeps the stream playable and marks it for a later bitrate recheck. A previous measured bitrate may be reused for ranking only; the current result remains N/A and visibly incomplete.',
